    ...
    <>
      {biodata.map((bio) => (
        <div key={bio._id} className="flex flex-col lg:flex-row gap-10">
          <div className="">
            <img className="max-h-screen w-full rounded-lg mt-4  md:mt-6 lg:mt-0" src={bio.profileImage} alt="" />
          </div>
          <div className="text-black border ">
            ...
            <div>
                <h2 className="uppercase text-3xl text-[#66451c] font-poppins font-semibold">Contact info</h2>
                <div className="flex items-center gap-6">
                <MdContactPhone className="text-[#66451c] text-2xl border rounded-lg border-solid border-[#66451c] p-2" />
                <h4 className="text-[#66451c] text-2xl border-[#66451c]" >Phone: <span className="text-xl">{bio.mobileNumber}</span></h4>
                </div>
                <div className="flex items-center gap-6 -my-8">
                <MdOutlineMail className="text-[#66451c] text-2xl border rounded-lg border-solid border-[#66451c] p-2" />
                <h4 className="text-[#66451c] text-2xl border-[#66451c]" >Email: <span className="text-xl">{bio.email}</span></h4>
                </div>
                <div className="flex items-center gap-6">
                <IoLocationSharp className="text-[#66451c] text-2xl border rounded-lg border-solid border-[#66451c] p-2" />
                <h4 className="text-[#66451c] text-2xl border-[#66451c]" >Address: <span className="text-xl">{bio.presentDivision}</span></h4>
                </div>
            </div>


            <div>
                <h2 className="uppercase text-3xl text-[#66451c] font-poppins font-semibold">Personal Information</h2>
