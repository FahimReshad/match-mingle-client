      ...
      <div className="text-black border ">
        ...
        <div className="flex gap-4">
          <div className="text-center bg-slate-100 pt-4 px-3 rounded-lg h-36 w-28">
            ...
            <h5 className="uppercase text-[#66451c]">{bio.presentDivision}</h5>
          </div>
          <div className="text-center bg-slate-100 pt-4 px-3 rounded-lg h-36 w-28">
        ...
        <div>
          ...
          <div className="flex items-center gap-6">
            ...
            <h4 className="text-[#66451c] text-2xl border-[#66451c]">
              Permanent Address:{" "}
              <span className="text-xl">{bio.permanentDivision}</span>
            </h4>
          </div>
        </div>
            ...
            {isPremium ? (
              ...
              <div className="mt-8 ">
                <Link to={`/checkout/${bio._id}`}>
                  <button className="bg-[#66451c] text-white p-2 rounded-lg font-poppins hover:cursor-pointer">
