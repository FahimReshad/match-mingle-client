...
const PremiumBioCards = () => {
  ...
  return (
    <div>
        <p  className="text-[#F2D184] text-center text-3xl font-poppins mt-6 md:mt-10 lg:mt-14">Moment's</p>
        <h2 className="text-[#66451c] text-center text-4xl font-poppins -mt-4">Our Premium Member's</h2>
      ...
      <Link to={`/biodata/details/${premiumBiodata._id}`} className="w-full"><button className="w-full rounded-full py-2 text-[12px] font-semibold text-[#66451c] ring-1 ring-[#66451c] hover:bg-[#66451c] hover:text-white sm:text-sm md:text-base">
        View Profile
      </button></Link>
    </div>
        </>)}
