...
const Banner = () => {
  ...
  const sliders = [{img: "https://i.ibb.co/ZgmJYLM/8011bf2cc1c0c795053ccbee93854394.jpg", tags: "Room",}, {img: "https://i.ibb.co/qnvsy6g/beautiful-couple-having-their-wedding-beach-23-2149043947.jpg", tags: "Room",}, {img: "https://i.ibb.co/W3LZvfm/pexels-photo-792777-jpeg-cs-srgb-dl-pexels-annetnavi-792777.jpg", tags: "Room",}, {img: "https://i.ibb.co/hXFFZ2N/depositphotos-212072892-stock-photo-portrait-happy-young-couple-hugging.webp", tags: "Room",},];
    ...
    return (
        ...
        <div className="w-1/2 lg:w-1/3 text-center lg:text-left space-y-2 lg:space-y-5 py-5">
            ...
            <h1 className="text-lg md:text-2xl lg:text-5xl font-bold text-[#66451c]">Find your
Right Match here</h1>
            <p className="text-[#616161] text-xs md:text-lg">Most trusted Matrimony Brand in the World.</p>
            <Link to='/biodatas'><button className="font-bold py-2 xl:py-3 text-xs md:text-base lg:text-lg xl:text-xl hover:scale-95 duration-300 px-4 lg:px-10 text-white bg-[#66451c] mt-4">Explore More</button></Link>
        </div>
        <div className="w-1/2">
        <CarouselMain />
        </div>
