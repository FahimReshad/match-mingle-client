    ...
    return (
        <div className="grid lg:grid-cols-3 gap-8 lg:w-2/3 mx-auto">
            <div className="shadow-2xl p-8 rounded-lg">
                ...
                <p className="text-[#66451c] text-xl">Most Trusted and premium Matrimony Service in the World.</p>
            ...
            <div className="text-center shadow-2xl p-8 rounded-lg">
                ...
                <p className="text-[#66451c] text-xl">Most Trusted and premium Matrimony Service in the World.</p>
                <button className="p-4 rounded-3xl border-[#66451c] font-bold text-[#66451c]">Get Support</button>
            </div>
            <div className="text-center shadow-2xl p-8 rounded-lg">
                <img className="h-32 w-32" src="https://i.ibb.co/94j0WPC/telephone.png" alt="" />
                <h3 className="text-xl ">WHATSAPP SUPPORT</h3>
                <p className="text-[#66451c] text-xl">Most Trusted and premium Matrimony Service in the World.</p>
                <button className="p-4 rounded-3xl border-[#66451c] font-bold text-[#66451c]">Talk to sales</button>
            </div>
        </div>
    );
};
